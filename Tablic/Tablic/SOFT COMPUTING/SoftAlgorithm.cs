...
namespace ORIProjekat
{
    public class SoftAlgorithm 
    {
        ...
        private double width = 612.0;
        private double height = 816.0;
        private List<String> resultThreads;

        public SoftAlgorithm()
        {
            decomponatedImage = new List<Image<Bgr, byte>>();
            resultThreads = new List<String>();
        }

        public List<Karta> Processing(string mainImagePath)
        {
           ...
           // Console.WriteLine("Isekao je: " + decomponatedImage.Count + "slika");
            ...
            System.Console.WriteLine("Prepoznate su karte.......................................\n\n\n");
            foreach (String result in resultThreads)
            {
                System.Console.WriteLine(result);
            }
            
            List<Karta> retListaKarata = new List<Karta>();

            foreach (String karta in resultThreads)
            {
                retListaKarata.Add(new Karta(karta));
            }

            return retListaKarata;
        }
        ...
        private void Recognize()
        {
            ...
            Image<Gray, byte> imgGray = ToGrayImage(0.5, 0.5, 0, imgColorFilter);//Pretvara se u sivu sliku
            //imgGray.Bitmap.Save("GrayTablic" + threadNumber + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            Image<Bgr, byte> contourImg = null;
            List<Contour<Point>> contourList = FindContoursOfImg(imgGray, out contourImg);//Izvlace se konture
            //contourImg.Bitmap.Save("ConTablic" + threadNumber + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            List<JednacinaPrave> jednacinePrava = HoughLines(new Image<Bgr, byte>(contourImg.Bitmap));//HoughLine transformacija
            //List<JednacinaPrave> jednacinePrava = HoughLines(contourImg);
            ...
            //imgPerspective.Bitmap.Save("PerTablic" + threadNumber + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            ...
            //imgPerspectiveGrayThr.Bitmap.Save("ThrTablic" + threadNumber + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            Image<Gray, Byte> imgPerspectiveGrayThrDilate = null;
            imgPerspectiveGrayThrDilate = imgPerspectiveGrayThr.Dilate(1);// Dilatcija
           // imgPerspectiveGrayThrDilate.Bitmap.Save("PERSPEKTIVADILATE" + threadNumber + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            ...
            lock (resultThreads)
            {
                resultThreads.Add(knnThreads.Start());
            }
